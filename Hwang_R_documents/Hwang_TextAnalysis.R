...
install.packages("gutenbergr") # cleaning corpora
...
## Direct Text: Emily Dickenson Poem
...
peace_res <- read.csv("~/Documents/Pratt/Data_Analytics/Data_analytics_labs/DataSets/pax_20_02_2018_1_CSV.csv",encoding = "utf-8")
str(peace_res)
glimpse(peace_res)
